...
(function () {
    ...
    //------------------------------------
    Cmn.Func.WebsiteAdaptive = function (mainContentWidth, mainContentHeight, adviseVerticalImgUrl,adaptiveMode,funEnd) {
        ...
        $(window).resize(function () {
            //如果是安卓，输入法导致的需要忽略掉,阀值加了50，有的安卓手机输入法顶上来了后高度还是大于宽度的
            if (Cmn.Func.IsAndroid() && Cmn.Func.IsHorizontalScreen()==false && $(window).width()+50 > $(window).height()) {
